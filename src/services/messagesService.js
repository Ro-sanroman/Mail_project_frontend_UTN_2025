...
async function createMessage(workspace_id, channel_id, content) {
  ...
  const url =
    ENVIRONMENT.URL_API +
    `/api/workspace/${workspace_id}/channels/${channel_id}/messages`;
  console.log("[MessagesService][POST] url:", url, {
    workspace_id,
    channel_id,
    body,
  });
...
export { getMessagesByChannelId, createMessage, deleteMessage };
